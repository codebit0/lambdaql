...
public class SelectCrossJoinQuery<T, J1> {
    ...
    public SelectCrossJoinQuery(SelectQuery<T> baseQuery, Class<J1> joinClass, JoinOn<T, J1> onCondition) {
    ...
    public SelectCrossJoinQuery<T, J1> where(Where<T, J1> condition) {
        return this;
    }
