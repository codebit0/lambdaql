...
public class SelectRightJoinQuery<T, J1> {
    ...
    public SelectRightJoinQuery(SelectQuery<T> baseQuery, Class<J1> joinClass, JoinOn<T, J1> onCondition) {
    ...
    public SelectRightJoinQuery<T, J1> where(Where<T, J1> condition) {
        return this;
    }
